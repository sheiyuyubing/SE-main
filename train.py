...
for method in method_list:
    ...
    train_loader = DataLoader(train_dataset, batch_size=1, shuffle=True, num_workers=0)  # 使用num_workers=0避免多线程问题
    ...
    torch.save(model.state_dict(), f'C:\\Users\\31986\\Desktop\\SE-main\\model\\model_{method}.pth')
